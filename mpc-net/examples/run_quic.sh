...
cargo run --example three_party_quic -- -c examples/config_party1.toml &
cargo run --example three_party_quic -- -c examples/config_party2.toml &
cargo run --example three_party_quic -- -c examples/config_party3.toml 
