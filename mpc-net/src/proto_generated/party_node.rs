...
pub mod party_node_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> PartyNodeClient<InterceptedService<T, F>>
        where
        ...
        {
            PartyNodeClient::new(InterceptedService::new(inner, interceptor))
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/party_node.PartyNode/Shutdown",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("party_node.PartyNode", "Shutdown"));
            self.inner.unary(req, path, codec).await
        }
    }
}
/// Generated server implementations.
pub mod party_node_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for PartyNodeServer<T>
    where
        T: PartyNode,
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/party_node.PartyNode/Shutdown" => {
                    #[allow(non_camel_case_types)]
                    struct ShutdownSvc<T: PartyNode>(pub Arc<T>);
                    impl<
                        T: PartyNode,
                    ...
                    for ShutdownSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PartyNode>::shutdown(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for PartyNodeServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "party_node.PartyNode";
    impl<T> tonic::server::NamedService for PartyNodeServer<T> {
