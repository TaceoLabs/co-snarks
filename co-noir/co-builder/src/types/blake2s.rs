...
impl<F: PrimeField> Blake2sState<F> {
    pub(crate) fn new() -> Self {
        let h: [FieldCT<F>; 8] = array::from_fn(|_| FieldCT::<F>::default());
        let t: [FieldCT<F>; 2] = array::from_fn(|_| FieldCT::<F>::default());
        let f: [FieldCT<F>; 2] = array::from_fn(|_| FieldCT::<F>::default());
        Self { h, t, f }
    }
}
