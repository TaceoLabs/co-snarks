...
impl<F: PrimeField> Blake3Hasher<F> {
    ...
    >(
        ...
        let mut state: [FieldCT<F>; BLAKE3_STATE_SIZE] = array::from_fn(|_| FieldCT::<F>::zero());
        self.compress_pre(
    ...
    >(
        ...
        let mut block_words: [FieldCT<F>; BLAKE3_STATE_SIZE] =
            array::from_fn(|_| FieldCT::<F>::zero());
...
pub fn blake3s<P: Pairing, T: NoirWitnessExtensionProtocol<P::ScalarField>>(
