...
impl<T: Default> IntoIterator for UltraPrecomputedEntities<T> {
    type Item = T;
    type IntoIter = std::array::IntoIter<T, { UltraFlavour::PRECOMPUTED_ENTITIES_SIZE }>;
...
impl<T: Default> UltraPrecomputedEntities<T> {
...
impl<T: Default> IntoIterator for UltraProverWitnessEntities<T> {
    type Item = T;
    type IntoIter = std::array::IntoIter<T, { UltraFlavour::PROVER_WITNESS_ENTITIES_SIZE }>;
...
impl<T: Default> UltraProverWitnessEntities<T> {
    pub fn iter(&self) -> impl Iterator<Item = &T> {
        self.elements.iter()
    }
...
impl<T: Default> IntoIterator for UltraWitnessEntities<T> {
    type Item = T;
    type IntoIter = std::array::IntoIter<T, { UltraFlavour::WITNESS_ENTITIES_SIZE }>;
...
impl<T: Default> UltraWitnessEntities<T> {
    pub fn iter(&self) -> impl Iterator<Item = &T> {
        self.elements.iter()
    }
...
impl<T: Default> IntoIterator for UltraShiftedWitnessEntities<T> {
    type Item = T;
    type IntoIter = std::array::IntoIter<T, { UltraFlavour::SHIFTED_WITNESS_ENTITIES_SIZE }>;
...
impl<T: Default> UltraShiftedWitnessEntities<T> {
    pub fn iter(&self) -> impl Iterator<Item = &T> {
        self.elements.iter()
    }
