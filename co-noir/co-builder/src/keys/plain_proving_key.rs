use crate::{
    ...
    types::types::{CyclicPermutation, Mapping, PermutationMapping, TraceData},
};
...
pub trait PlainPkTrait<P: CurveGroup> {
    fn create<T: NoirWitnessExtensionProtocol<P::ScalarField>>(
    ...
    fn add_memory_records_to_proving_key<T: NoirWitnessExtensionProtocol<P::ScalarField>>(
        ram_rom_offset: u32,
    ...
    fn compute_permutation_argument_polynomials<T: NoirWitnessExtensionProtocol<P::ScalarField>>(
    ...
    fn construct_lookup_table_polynomials<T: NoirWitnessExtensionProtocol<P::ScalarField>>(
...
impl<P: CurveGroup> PlainPkTrait<P> for PlainProvingKey<P> {
