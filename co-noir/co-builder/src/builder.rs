...
use crate::{
    ...
    types::{
        ...
        types::{
            ...
            CachedPartialNonNativeFieldMultiplication, ColumnIdx, FieldCT, GateCounter, MulQuad,
            PairingPointAccumulatorIndices, PairingPointAccumulatorPubInputIndices,
            PlookupBasicTable, PolyTriple, RamTranscript, RangeConstraint, RangeList, ReadData,
...
impl<P: Pairing, T: NoirWitnessExtensionProtocol<P::ScalarField>> GenericUltraCircuitBuilder<P, T> {
    ...
    fn process_honk_recursion_constraints(
        &mut self,
        constraint_system: &mut AcirFormat<P::ScalarField>,
        has_valid_witness_assignments: bool,
            ...
            .enumerate()
        {
            ...
            gate_counter.track_diff(
                ...
                constraint_system
                    .original_opcode_indices
                    .honk_recursion_constraints[idx],
            );
        }
        current_aggregation_object
    }
