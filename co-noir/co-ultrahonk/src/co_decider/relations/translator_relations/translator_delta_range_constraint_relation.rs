...
use co_builder::{HonkProofResult, prelude::HonkCurve};
    ...
    for TranslatorDeltaRangeConstraintRelation
{
    ...
    fn accumulate<N: Network, const SIZE: usize>(
        ...
        let capacity = delta_1.len() * 10; //TODO FLORIN
        ...
        fold_accumulator!(univariate_accumulator.r1, delta_1_result, SIZE);
        fold_accumulator!(univariate_accumulator.r2, delta_2_result, SIZE);
        fold_accumulator!(univariate_accumulator.r3, delta_3_result, SIZE);
        fold_accumulator!(univariate_accumulator.r4, delta_4_result, SIZE);
        fold_accumulator!(univariate_accumulator.r5, delta_5_result, SIZE);
