...
use ultra_arithmetic_relation::{
    UltraArithmeticRelation, UltraArithmeticRelationAcc, UltraArithmeticRelationAccNotReshared,
};
...
pub(crate) struct AllRelationAccNotReshared<T: NoirUltraHonkProver<P>, P: Pairing> {
    pub(crate) r_arith: UltraArithmeticRelationAccNotReshared<T, P>,
    pub(crate) r_perm: UltraPermutationRelationAcc<T, P>,
    pub(crate) r_lookup: LogDerivLookupRelationAcc<T, P>,
    pub(crate) r_delta: DeltaRangeConstraintRelationAcc<T, P>,
    pub(crate) r_elliptic: EllipticRelationAcc<T, P>,
...
impl<T: NoirUltraHonkProver<P>, P: Pairing> AllRelationAccNotReshared<T, P> {
...
impl<T: NoirUltraHonkProver<P>, P: Pairing> Default for AllRelationAccNotReshared<T, P> {
    fn default() -> Self {
        Self {
            r_arith: Default::default(),
            r_perm: Default::default(),
