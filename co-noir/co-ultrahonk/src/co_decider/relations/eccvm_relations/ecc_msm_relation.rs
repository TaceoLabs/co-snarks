    ...
    for EccMsmRelation
{
    ...
    fn accumulate<N: Network, const SIZE: usize>(
        ...
        rhs2.extend(T::add_many(&T::sub_many(skew_relation_1_term, y1), acc_x)); // this gives us the mul of skew_relation_1
        ...
        let mut x_out_24 = T::add_many(mul4[12], lambda3_sqr);
        T::add_assign_many(&mut x_out_24, &x_out_23);

        let mut lhs5 = Vec::with_capacity(1); // TODO FLORIN
        ...
        let mut lhs6 = Vec::with_capacity(1); // TODO FLORIN
