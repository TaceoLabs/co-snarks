...
impl DataBusLookupRelation {
    ...
    >(
        ...
        for (i, val) in id.iter().cloned().enumerate() {
    ...
    fn verify_accumulate_subrelation_contributions<
        T: NoirUltraHonkProver<P>,
        P: HonkCurve<TranscriptFieldType>,
        N: Network,
        L: MPCProverFlavour,
    ...
    Relation<T, P, L> for DataBusLookupRelation
{
    ...
    fn verify_accumulate<N: Network>(
        ...
        // TODO this can be parallelized
        for bus_idx in 0..Self::NUM_BUS_COLUMNS {
            DataBusLookupRelation::verify_accumulate_subrelation_contributions::<T, P, N, L>(
                net,
                state,
                accumulator,
                input,
