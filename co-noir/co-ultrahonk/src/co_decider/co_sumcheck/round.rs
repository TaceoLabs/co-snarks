...
impl SumcheckRound {
    ...
    >(
        ...
        alphas: &L::Alphas<P::ScalarField>, //TODO ALPHAS_ISSUE
        gate_separators: &GateSeparatorPolynomial<P::ScalarField>,
    ...
    // >(
    //     driver: &mut T,
    //     univariate_accumulators: &mut L::AllRelationAccHalfShared<T, P>,
    //     sum_check_data: &AllEntitiesBatchRelations<T, P, L>,
    //     relation_parameters: &RelationParameters<P::ScalarField, L>,
    // ) -> HonkProofResult<()> {
    //     tracing::trace!("Accumulate relations");
    //     Self::accumulate_one_relation_univariates_batch::<_, _, L, UltraArithmeticRelation>(
    //         driver,
    ...
    //     Self::accumulate_one_relation_univariates_batch::<_, _, L, UltraPermutationRelation>(
    //         driver,
    ...
    //     Self::accumulate_one_relation_univariates_batch::<_, _, L, DeltaRangeConstraintRelation>(
    //         driver,
    ...
    //     Self::accumulate_one_relation_univariates_batch::<_, _, L, EllipticRelation>(
    //         driver,
    ...
    //     Self::accumulate_one_relation_univariates_batch::<_, _, L, AuxiliaryRelation>(
    //         driver,
    ...
    //     Self::accumulate_one_relation_univariates_batch::<_, _, L, LogDerivLookupRelation>(
    //         driver,
    //         &mut univariate_accumulators.r_lookup,
    //         relation_parameters,
    //         &sum_check_data.log_lookup,
    //     )?;
    //     Self::accumulate_one_relation_univariates_batch::<_, _, L, Poseidon2ExternalRelation>(
    //         driver,
    //         &mut univariate_accumulators.r_pos_ext,
    //         relation_parameters,
    //         &sum_check_data.poseidon_ext,
    //     )?;
    //     Self::accumulate_one_relation_univariates_batch::<_, _, L, Poseidon2InternalRelation>(
    //         driver,
    ...
    >(
        ...
        let univariate_accumulators = L::reshare(univariate_accumulators, driver)?;
    ...
    >(
        ...
        self.compute_univariate_inner::<T, P, L>(
            driver,
            relation_parameters,
            gate_separators,
            polynomials,
    ...
    >(
        ...
        let round_univariate = self.compute_univariate_inner_zk::<T, P, L>(
            driver,
            relation_parameters,
            gate_separators,
            polynomials,
        ...
        let contribution_from_disabled_rows = Self::compute_disabled_contribution::<T, P, L>(
            driver,
            polynomials,
            relation_parameters,
            gate_separators,
