...
impl CoUtils {
    ...
    pub(crate) fn msm<T: NoirUltraHonkProver<P>, P: CurveGroup>(
        poly: &[T::ArithmeticShare],
        crs: &[P::Affine],
    ) -> T::PointShare {
        let len = poly.len();
    ...
    pub(crate) fn batch_invert<T: NoirUltraHonkProver<P>, P: CurveGroup, N: Network>(
    ...
    pub(crate) fn batch_invert_leaking_zeros<
