...
pub(crate) struct AllRelationAccMega<T: NoirUltraHonkProver<P>, P: Pairing> {
...
pub(crate) struct AllRelationAccHalfSharedMega<T: NoirUltraHonkProver<P>, P: Pairing> {
...
impl<T: NoirUltraHonkProver<P>, P: Pairing> Default for AllRelationAccHalfSharedMega<T, P> {
    fn default() -> Self {
...
pub(crate) struct AllEntitiesBatchRelationsMega<T, P>
where
...
impl MPCProverFlavour for MegaFlavour {
    ...
    fn reshare<T: NoirUltraHonkProver<P>, P: Pairing>(
        ...
        let r_arith_r0 = driver.reshare(acc.r_arith.r0.evaluations.to_vec())?;
