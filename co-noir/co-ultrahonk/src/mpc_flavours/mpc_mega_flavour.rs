...
impl MPCProverFlavour for MegaFlavour {
    ...
    >(
        ...
        UltraArithmeticRelation::verify_accumulate(
            net,
            state,
        ...
        UltraPermutationRelation::verify_accumulate(
            net,
            state,
        ...
        DeltaRangeConstraintRelation::verify_accumulate(
            net,
            state,
        ...
        AuxiliaryRelation::verify_accumulate(
            net,
            state,
        ...
        LogDerivLookupRelation::verify_accumulate(
            net,
            state,
        ...
        EccOpQueueRelation::verify_accumulate(
            net,
            state,
        ...
        DataBusLookupRelation::verify_accumulate(
            net,
            state,
        ...
        Poseidon2ExternalRelation::verify_accumulate(
            net,
            state,
        ...
        Poseidon2InternalRelation::verify_accumulate(
            net,
            state,
