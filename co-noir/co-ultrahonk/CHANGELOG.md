...
## [0.6.0](https://github.com/TaceoLabs/co-snarks/compare/co-ultrahonk-v0.5.0...co-ultrahonk-v0.6.0) (2025-04-11)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * co-builder bumped from 0.4.0 to 0.4.1
    * mpc-core bumped from 0.9.0 to 0.10.0
    * ultrahonk bumped from 0.5.0 to 0.5.1
