...
# run proving in MPC
cargo run --release --bin co-noir -- generate-proof --proving-key proving_key.0.shared --protocol REP3 --hasher KECCAK --crs test_vectors/bn254_g1.dat --config configs/party1.toml --out proof.0.proof --public-input public_input.json &
