...
cargo run --release --bin co-noir -- create-vk --circuit test_vectors/poseidon_input2/poseidon_input2.json --crs ../../co-noir-common/src/crs/bn254_g1.dat --hasher keccak --vk test_vectors/poseidon_input2/verification_key
# run proving in MPC
cargo run --release --bin co-noir -- build-and-generate-proof --witness test_vectors/poseidon_input2/poseidon_input2.gz.0.shared --circuit test_vectors/poseidon_input2/poseidon_input2.json --crs ../../co-noir-common/src/crs/bn254_g1.dat --protocol REP3 --hasher keccak --config configs/party1.toml --out proof.0.proof --public-input public_input --vk test_vectors/poseidon_input2/verification_key &
cargo run --release --bin co-noir -- build-and-generate-proof --witness test_vectors/poseidon_input2/poseidon_input2.gz.1.shared --circuit test_vectors/poseidon_input2/poseidon_input2.json --crs ../../co-noir-common/src/crs/bn254_g1.dat --protocol REP3 --hasher keccak --config configs/party2.toml --out proof.1.proof --vk test_vectors/poseidon_input2/verification_key &
cargo run --release --bin co-noir -- build-and-generate-proof --witness test_vectors/poseidon_input2/poseidon_input2.gz.2.shared --circuit test_vectors/poseidon_input2/poseidon_input2.json --crs ../../co-noir-common/src/crs/bn254_g1.dat --protocol REP3 --hasher keccak --config configs/party3.toml --out proof.2.proof --vk test_vectors/poseidon_input2/verification_key
wait $(jobs -p)
# verify proof
cargo run --release --bin co-noir -- verify --proof proof.0.proof --public-input public_input --vk test_vectors/poseidon_input2/verification_key --hasher keccak --crs ../../co-noir-common/src/crs/bn254_g2.dat
