...
cargo run --release --bin co-noir -- build-proving-key --witness test_vectors/poseidon/shamir_poseidon.gz.0.shared --circuit test_vectors/poseidon/poseidon.json --protocol SHAMIR --config configs/party1.toml --out proving_key.0.shared --crs ../../co-noir-common/src/crs/bn254_g1.dat &
cargo run --release --bin co-noir -- build-proving-key --witness test_vectors/poseidon/shamir_poseidon.gz.1.shared --circuit test_vectors/poseidon/poseidon.json --protocol SHAMIR --config configs/party2.toml --out proving_key.1.shared --crs ../../co-noir-common/src/crs/bn254_g1.dat &
cargo run --release --bin co-noir -- build-proving-key --witness test_vectors/poseidon/shamir_poseidon.gz.2.shared --circuit test_vectors/poseidon/poseidon.json --protocol SHAMIR --config configs/party3.toml --out proving_key.2.shared --crs ../../co-noir-common/src/crs/bn254_g1.dat
# run proving in MPC
cargo run --release --bin co-noir -- generate-proof --proving-key proving_key.0.shared --protocol SHAMIR --hasher keccak --crs ../../co-noir-common/src/crs/bn254_g1.dat --config configs/party1.toml --out proof.0.proof --vk test_vectors/poseidon/verification_key --public-input public_input &
cargo run --release --bin co-noir -- generate-proof --proving-key proving_key.1.shared --protocol SHAMIR --hasher keccak --crs ../../co-noir-common/src/crs/bn254_g1.dat --config configs/party2.toml --out proof.1.proof --vk test_vectors/poseidon/verification_key &
cargo run --release --bin co-noir -- generate-proof --proving-key proving_key.2.shared --protocol SHAMIR --hasher keccak --crs ../../co-noir-common/src/crs/bn254_g1.dat --config configs/party3.toml --out proof.2.proof --vk test_vectors/poseidon/verification_key
wait $(jobs -p)
# verify proof
