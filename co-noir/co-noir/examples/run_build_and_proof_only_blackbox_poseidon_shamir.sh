...
# verify proof
cargo run --release --bin co-noir -- verify --proof proof.0.proof --vk test_vectors/blackbox_poseidon2/verification_key --hasher KECCAK --crs test_vectors/bn254_g2.dat
