...
cargo run --release --bin co-noir -- merge-input-shares --inputs test_vectors/poseidon_input2/Prover1.toml.1.shared --inputs test_vectors/poseidon_input2/Prover2.toml.1.shared --protocol REP3 --out test_vectors/poseidon_input2/Prover.toml.1.shared
cargo run --release --bin co-noir -- merge-input-shares --inputs test_vectors/poseidon_input2/Prover1.toml.2.shared --inputs test_vectors/poseidon_input2/Prover2.toml.2.shared --protocol REP3 --out test_vectors/poseidon_input2/Prover.toml.2.shared
...
wait $(jobs -p)
# run proving in MPC
cargo run --release --bin co-noir -- generate-proof --witness test_vectors/poseidon_input2/poseidon_input2.gz.0.shared --circuit test_vectors/poseidon_input2/poseidon_input2.json --crs test_vectors/bn254_g1.dat --protocol REP3 --hasher KECCAK --config configs/party1.toml --out proof.0.proof --public-input public_input.json &
cargo run --release --bin co-noir -- generate-proof --witness test_vectors/poseidon_input2/poseidon_input2.gz.1.shared --circuit test_vectors/poseidon_input2/poseidon_input2.json --crs test_vectors/bn254_g1.dat --protocol REP3 --hasher KECCAK --config configs/party2.toml --out proof.1.proof &
cargo run --release --bin co-noir -- generate-proof --witness test_vectors/poseidon_input2/poseidon_input2.gz.2.shared --circuit test_vectors/poseidon_input2/poseidon_input2.json --crs test_vectors/bn254_g1.dat --protocol REP3 --hasher KECCAK --config configs/party3.toml --out proof.2.proof
wait $(jobs -p)
...
# verify proof
cargo run --release --bin co-noir -- verify --proof proof.0.proof --vk test_vectors/poseidon_input2/verification_key --hasher KECCAK --crs test_vectors/bn254_g2.dat
