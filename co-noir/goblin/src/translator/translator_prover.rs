...
impl<P: HonkCurve<TranscriptFieldType>, H: TranscriptHasher<TranscriptFieldType>> Translator<P, H> {
    ...
    fn construct_proof(
        ...
        proving_key: &mut ProvingKey<P, TranslatorFlavour>, //TODO FLORIN: This has to be Grumpkin, so we need the Grumpkin CRS as well
    ) -> HonkProofResult<(
    ...
    fn compute_logderivative_inverses(&mut self, proving_key: &ProvingKey<P, TranslatorFlavour>) {
