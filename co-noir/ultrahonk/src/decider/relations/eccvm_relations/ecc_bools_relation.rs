...
impl<F: PrimeField> Relation<F, ECCVMFlavour> for EccBoolsRelation {
    ...
    fn accumulate<const SIZE: usize>(
        ...
        let mut tmp = q_eq.to_owned() - &F::one();
        tmp *= q_eq;
        tmp *= scaling_factor;
        ...
        tmp = transcript_msm_transition.to_owned() - &F::one();
        ...
        tmp = is_accumulator_empty.to_owned() - &F::one();
        ...
        tmp = transcript_add_y_equal.to_owned() - &F::one();
        ...
        tmp = transcript_pinfinity.to_owned() - &F::one();
        ...
        tmp = transcript_msm_infinity.to_owned() - &F::one();
        ...
        tmp = msm_count_zero_at_transition.to_owned() - &F::one();
