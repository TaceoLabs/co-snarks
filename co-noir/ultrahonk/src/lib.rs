...
impl Utils {
    pub(crate) fn field_from_hex_string<F: PrimeField>(str: &str) -> Result<F, Error> {
        circuit_builder::prelude::Utils::field_from_hex_string(str)
    }
    ...
    pub fn get_msb32(inp: u32) -> u32 {
        circuit_builder::prelude::Utils::get_msb32(inp)
    }

    pub fn round_up_power_2(inp: usize) -> usize {
        circuit_builder::prelude::Utils::round_up_power_2(inp)
    }

    pub fn get_msb64(inp: u64) -> u32 {
        circuit_builder::prelude::Utils::get_msb64(inp)
    }

    fn batch_invert<F: PrimeField>(coeffs: &mut [F]) {
        circuit_builder::prelude::Utils::batch_invert(coeffs);
    }
    ...
    pub fn commit<P: Pairing>(
        ...
        circuit_builder::prelude::Utils::commit(poly, crs)
    }

    pub fn msm<P: Pairing>(poly: &[P::ScalarField], crs: &[P::G1Affine]) -> HonkProofResult<P::G1> {
        circuit_builder::prelude::Utils::msm::<P>(poly, crs)
    }
}
