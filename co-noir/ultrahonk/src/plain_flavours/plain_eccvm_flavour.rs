...
impl PlainProverFlavour for ECCVMFlavour {
    ...
    fn scale<F: ark_ff::PrimeField>(
        ...
        acc.r_ecc_bools
            .scale(&[*elements; EccBoolsRelation::NUM_RELATIONS]);
        acc.r_ecc_lookup
            .scale(&[*elements; EccLookupRelation::NUM_RELATIONS]);
        acc.r_ecc_msm
            .scale(&[*elements; EccMsmRelation::NUM_RELATIONS]);
        acc.r_ecc_set
            .scale(&[*elements; EccSetRelation::NUM_RELATIONS]);
        acc.r_ecc_wnaf
            .scale(&[*elements; EccWnafRelation::NUM_RELATIONS]);
    }
