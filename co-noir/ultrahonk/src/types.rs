...
pub const NUM_ALL_ENTITIES: usize = WITNESS_ENTITIES_SIZE
...
impl<T: Default> WitnessEntities<T> {
    ...
    pub const LOOKUP_INVERSES: usize = 5;
    /// column 6
    pub const LOOKUP_READ_COUNTS: usize = 6;
    /// column 7
    pub const LOOKUP_READ_TAGS: usize = 7;
