...
This crate is a rewrite of Atec's UltraHonk prover and verifier in Rust. It is compatible with Barretenberg v0.66.0. To get Barretenberg with this version, use the following commands:
