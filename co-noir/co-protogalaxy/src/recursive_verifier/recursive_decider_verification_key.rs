...
use co_builder::{transcript::TranscriptFieldType, types::{field_ct::FieldCT, goblin_types::GoblinElement}};
use co_ultrahonk::co_decider::types::RelationParameters;
use common::honk_curve::HonkCurve;

use crate::recursive_verifier::WitnessCommitments;

pub struct RecursiveDeciderVerificationKey<P: HonkCurve<TranscriptFieldType, ScalarField = TranscriptFieldType>, T: NoirWitnessExtensionProtocol<P::ScalarField>> {
