...
impl GarbledCircuits {
    ...
    >(
        ...
        if base_bit.count_ones() == 1 {
            ...
            if base_bit.count_ones() == 1 {
                todo!("Base is not a power of 2, should not happen");
            } else {
    ...
    /// Computes the Choose Normalization Table value for the given input. The input is expected to be of length 3. The arithmetization comes from a Moebius Transformation on the truth table.
