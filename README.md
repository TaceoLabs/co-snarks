...
[Apache](LICENSE.Apache-2.0), at your choice.
...
- **collaborative-circom**: Licensed under [GPL-3.0](LICENSE.GPL-3.0-only) `SPDX-License-Identifier: GPL-3.0-only`.
- **circom-mpc-compiler**: Licensed under [GPL-3.0](LICENSE.GPL-3.0-only) `SPDX-License-Identifier: GPL-3.0-only`.
