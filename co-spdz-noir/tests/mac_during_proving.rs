...
fn test_proving_with_mac_verification_enabled() {
    let circuit_file = "../test_circuits/mul_shared/kat/mul_shared.json";
    let witness_file = "../test_circuits/mul_shared/kat/mul_shared.gz";
...
fn test_proving_with_mac_verification_disabled() {
    let circuit_file =
        "../../co-snarks/test_vectors/noir/addition_multiplication/kat/addition_multiplication.json";
    let witness_file =
        "../../co-snarks/test_vectors/noir/addition_multiplication/kat/addition_multiplication.gz";
