...
impl<'a, P: Pairing, T: CircomPlonkProver<P>> Round2<'a, P, T> {
    ...
    fn compute_z(
        ...
        let num_den_span = tracing::trace_span!("compute num/den").entered();
        ...
        let batched_mul_span = tracing::trace_span!("buffer z network round").entered();
        ...
        let fft_span = tracing::trace_span!("fft-ifft for z(x)").entered();
