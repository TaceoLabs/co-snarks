...
pub mod tests {
    ...
    use circom_types::plonk::{PlonkProof, VerificationKey as JsonVerificationKey};
    ...
    pub fn calculate_verifier_challenges() {
        ...
        let challenges = VerifierChallenges::new(&vk, &proof, &public_inputs.0);
        assert_eq!(
            challenges.alpha,
    ...
    pub fn verify_multiplier2_from_circom() {
        ...
        .unwrap();
        Plonk::verify(&vk, &proof, &public_inputs.0).unwrap();
    }
