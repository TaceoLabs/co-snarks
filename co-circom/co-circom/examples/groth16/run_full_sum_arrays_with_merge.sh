...
cargo run --release --bin co-circom -- merge-input-shares --circuit test_vectors/sum_arrays/circuit.circom --inputs test_vectors/sum_arrays/input0.json.0.shared --inputs test_vectors/sum_arrays/input1.json.0.shared --protocol REP3 --curve BN254 --out test_vectors/sum_arrays/input01.json.0.shared
cargo run --release --bin co-circom -- merge-input-shares --circuit test_vectors/sum_arrays/circuit.circom --inputs test_vectors/sum_arrays/input0.json.1.shared --inputs test_vectors/sum_arrays/input1.json.1.shared --protocol REP3 --curve BN254 --out test_vectors/sum_arrays/input01.json.1.shared
cargo run --release --bin co-circom -- merge-input-shares --circuit test_vectors/sum_arrays/circuit.circom --inputs test_vectors/sum_arrays/input0.json.2.shared --inputs test_vectors/sum_arrays/input1.json.2.shared --protocol REP3 --curve BN254 --out test_vectors/sum_arrays/input01.json.2.shared
cargo run --release --bin co-circom -- merge-input-shares --circuit test_vectors/sum_arrays/circuit.circom --inputs test_vectors/sum_arrays/input01.json.0.shared --inputs test_vectors/sum_arrays/input2.json.0.shared --protocol REP3 --curve BN254 --out test_vectors/sum_arrays/input.json.0.shared
cargo run --release --bin co-circom -- merge-input-shares --circuit test_vectors/sum_arrays/circuit.circom --inputs test_vectors/sum_arrays/input01.json.1.shared --inputs test_vectors/sum_arrays/input2.json.1.shared --protocol REP3 --curve BN254 --out test_vectors/sum_arrays/input.json.1.shared
cargo run --release --bin co-circom -- merge-input-shares --circuit test_vectors/sum_arrays/circuit.circom --inputs test_vectors/sum_arrays/input01.json.2.shared --inputs test_vectors/sum_arrays/input2.json.2.shared --protocol REP3 --curve BN254 --out test_vectors/sum_arrays/input.json.2.shared
