...
cargo run --release --bin co-circom -- merge-input-shares --inputs test_vectors/semaphore/input0.json.0.shared --inputs test_vectors/semaphore/input1.json.0.shared --protocol REP3 --curve BN254 --out test_vectors/semaphore/input.json.0.shared
cargo run --release --bin co-circom -- merge-input-shares --inputs test_vectors/semaphore/input0.json.1.shared --inputs test_vectors/semaphore/input1.json.1.shared --protocol REP3 --curve BN254 --out test_vectors/semaphore/input.json.1.shared
cargo run --release --bin co-circom -- merge-input-shares --inputs test_vectors/semaphore/input0.json.2.shared --inputs test_vectors/semaphore/input1.json.2.shared --protocol REP3 --curve BN254 --out test_vectors/semaphore/input.json.2.shared
...
wait $(jobs -p)
# run proving in MPC
cargo run --release --bin co-circom -- generate-proof groth16 --witness test_vectors/semaphore/witness.wtns.0.shared --zkey test_vectors/semaphore/semaphore.zkey --protocol REP3 --curve BN254 --config ../configs/party1.toml --out proof.0.json --public-input public_input.json &
cargo run --release --bin co-circom -- generate-proof groth16 --witness test_vectors/semaphore/witness.wtns.1.shared --zkey test_vectors/semaphore/semaphore.zkey --protocol REP3 --curve BN254 --config ../configs/party2.toml --out proof.1.json &
cargo run --release --bin co-circom -- generate-proof groth16 --witness test_vectors/semaphore/witness.wtns.2.shared --zkey test_vectors/semaphore/semaphore.zkey --protocol REP3 --curve BN254 --config ../configs/party3.toml --out proof.2.json
# verify proof
