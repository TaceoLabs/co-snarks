...
cargo run --release --bin co-circom -- split-witness --witness groth16/test_vectors/poseidon/witness.wtns --r1cs groth16/test_vectors/poseidon/poseidon.r1cs --protocol REP3 --curve BN254 --out-dir groth16/test_vectors/poseidon
# run proving in MPC
