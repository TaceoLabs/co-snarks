...
pub use crate::mpc::plain::PlainGroth16Driver;
pub use crate::mpc::rep3::Rep3Groth16Driver;
pub use crate::mpc::shamir::ShamirGroth16Driver;
...
impl<P: Pairing, T: CircomGroth16Prover<P>> CoGroth16<P, T> {
    ...
    fn prove_inner<N: Network, R: R1CSToQAP>(
        ...
        let num_witness_variables = private_witness.witness.len();
